...
return (
  <main>
    ...
    <button disabled={!userSubscription || !pushServerSubscriptionId} onClick={onClickCancelSubscriptionToPushServer}>
      {!pushServerSubscriptionId ? "Unsubscription sent to the server" : "Unsubscribe to push server"}
    </button>
